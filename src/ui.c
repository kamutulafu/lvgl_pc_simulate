...
///////////////////// VARIABLES ////////////////////
lv_anim_t * topon_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * topoff_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * lefton_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * leftoff_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * opaon_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * opaoff_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * arrow_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * buttonon_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * buttonoff_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * bed_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * printer_in_Animation(lv_obj_t * TargetObject, int delay);
...
lv_anim_t * printer_in_Animation(lv_obj_t * TargetObject, int delay)
{
    ...
    PropertyAnimation_0_user_data->imgset_size = sizeof(ui_imgset_printer_in_) / (sizeof(lv_image_dsc_t *));
    PropertyAnimation_0_user_data->val = -1;
    lv_anim_t PropertyAnimation_0;
    lv_anim_init(&PropertyAnimation_0);
    lv_anim_set_time(&PropertyAnimation_0, 600);
...
void ui_destroy(void)
{
    ...
    ui_step3_screen_destroy();
    ui_final_screen_destroy();
    ui_main_menu_screen_destroy();
    ui_printing_screen_destroy();
