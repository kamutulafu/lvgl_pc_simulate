...
lv_obj_t * ui_dot_create(lv_obj_t * comp_parent)
{
    ...
    lv_obj_set_width(cui_dot, 50);
    lv_obj_set_height(cui_dot, 50);
    lv_obj_set_align(cui_dot, LV_ALIGN_CENTER);
    lv_obj_remove_flag(cui_dot, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_radius(cui_dot, 50, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(cui_ready_bg, 50);
    lv_obj_set_height(cui_ready_bg, 50);
    lv_obj_set_align(cui_ready_bg, LV_ALIGN_CENTER);
    lv_obj_add_flag(cui_ready_bg, LV_OBJ_FLAG_HIDDEN);     /// Flags
    lv_obj_remove_flag(cui_ready_bg, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_radius(cui_ready_bg, 50, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_t * cui_ready;
    cui_ready = lv_image_create(cui_dot);
    lv_image_set_src(cui_ready, &ui_img_ok_small_png);
    ...
    lv_obj_remove_flag(cui_ready, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    lv_obj_t ** children = lv_malloc(sizeof(lv_obj_t *) * _UI_COMP_DOT_NUM);
